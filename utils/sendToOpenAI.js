...
function buildPrompts(html) {
  const system = `You are a LinkedIn profile data extraction expert. Return ONLY valid JSON using the exact schema (profile, experience[], education[], awards[], certifications[], skills[], engagement...). No markdown.`;
