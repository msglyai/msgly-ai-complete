...
// GET /messages/history - Get messages for user (ORIGINAL WORKING VERSION - UNCHANGED)
...
// PUT /messages/:id - Update message status and comments (ORIGINAL WORKING VERSION - UNCHANGED)
...
// ==================== EMAIL FINDER ENDPOINT - ONLY CHANGE ====================

// POST /api/ask-email - Find email using LinkedIn URL directly (ONLY MODIFIED ENDPOINT)
